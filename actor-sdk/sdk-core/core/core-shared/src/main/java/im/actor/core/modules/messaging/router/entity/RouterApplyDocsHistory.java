...
public class RouterApplyDocsHistory implements AskMessage<Void>, RouterMessageOnlyActive {
    ...
    public RouterApplyDocsHistory(Peer peer, List<Message> messages, Long maxReceiveDate,

...
public class RequestUnfavouriteDialog extends Request<ResponseDialogsOrder> {
    ...
    public static RequestUnfavouriteDialog fromBytes(byte[] data) throws IOException {
        return Bser.parse(new RequestUnfavouriteDialog(), data);
    }

    private ApiOutPeer peer;

    public RequestUnfavouriteDialog(@NotNull ApiOutPeer peer) {
        this.peer = peer;
    }
    ...
    public String toString() {
        String res = "rpc UnfavouriteDialog{";
        res += "peer=" + this.peer;
        res += "}";
        return res;
    }

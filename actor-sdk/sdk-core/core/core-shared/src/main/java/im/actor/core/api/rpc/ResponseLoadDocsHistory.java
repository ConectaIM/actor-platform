...
public class ResponseLoadDocsHistory extends Response {
    ...
    public ResponseLoadDocsHistory(@NotNull List<ApiMessageContainer> history, @NotNull List<ApiUser> users, @NotNull List<ApiUserOutPeer> userPeers, @NotNull List<ApiGroup> groups, @NotNull List<ApiGroupOutPeer> groupPeers) {

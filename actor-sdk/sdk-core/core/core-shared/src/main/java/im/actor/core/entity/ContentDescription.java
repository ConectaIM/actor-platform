...
public class ContentDescription extends BserObject {
    ...
    public ContentDescription(int contentType, String text, int relatedUser,
                              boolean isSilent) {
    ...
    public ContentDescription(int contentType, String text) {
        this(contentType, text, 0, false);
    }

    public ContentDescription(int contentType) {

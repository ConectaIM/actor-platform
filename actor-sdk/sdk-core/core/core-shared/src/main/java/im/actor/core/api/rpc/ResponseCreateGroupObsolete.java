...
public class ResponseCreateGroupObsolete extends Response {
    ...
    public static ResponseCreateGroupObsolete fromBytes(byte[] data) throws IOException {
        return Bser.parse(new ResponseCreateGroupObsolete(), data);
    }
    ...
    public ResponseCreateGroupObsolete(@NotNull ApiGroupOutPeer groupPeer, int seq, @NotNull byte[] state, @NotNull List<Integer> users, long date) {
    ...
    public String toString() {
        String res = "tuple CreateGroupObsolete{";
        res += "}";
        return res;
    }

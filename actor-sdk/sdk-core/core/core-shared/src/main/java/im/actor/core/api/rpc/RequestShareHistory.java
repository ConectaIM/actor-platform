...
public class RequestShareHistory extends Request<ResponseSeq> {
    ...
    public static final int HEADER = 0xaec;

    public static RequestShareHistory fromBytes(byte[] data) throws IOException {
        return Bser.parse(new RequestShareHistory(), data);
    }

    private ApiGroupOutPeer groupPeer;

    public RequestShareHistory(@NotNull ApiGroupOutPeer groupPeer) {
